 ...
 */
	...
	if ( class_exists( 'Customizer_Control_Radio_Image' ) ) {
		...
		$wp_customize->add_control(
			new Customizer_Control_Radio_Image(
				...
				'yith_proteo_product_category_page_sidebar_position',
				array(
					'label'       => esc_html_x( 'Choose the position of the sidebar on product category pages', 'Customizer option name', 'yith-proteo' ),
	...
	$wp_customize->add_control(
		...
		array(
			'type'            => 'select',
			'label'           => esc_html_x( 'Choose the product category page sidebar', 'Customizer option name', 'yith-proteo' ),
			'section'         => 'yith_proteo_product_category_page_management',
