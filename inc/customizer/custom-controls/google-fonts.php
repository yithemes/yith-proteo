 ...
 */
function yith_proteo_font_selector_get_standard_fonts() {
	return apply_filters(
		'yith_proteo_standard_fonts_array',
		array(
 ...
 * @since 1.1.38
 */
function yith_proteo_font_selector_enqueue_google_font( $font ) {
	...
	$weights = apply_filters( 'font_weights', array( '300', '400', '500', '700' ) );
