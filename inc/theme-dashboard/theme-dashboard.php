			...
			<div id="aside">
				...
				<div class="content">
					...
					<ul id="useful-link-list">
						...
						<li><img src="<?php echo esc_url( get_template_directory_uri() . '/img/start-customize-icon.svg' ); ?>" alt="<?php esc_attr_e( 'Use theme customizer', 'yith-proteo' ); ?>"><?php echo sprintf( '%1s <a href="https://wordpress.org/support/theme/yith-proteo/" target="_blank" rel="noopener nofollow">%2s ></a>', esc_html__( 'Start to customize with the', 'yith-proteo' ), esc_html__( 'live customizer', 'yith-proteo' ) ); ?></li>
					</ul>
				</div>
			</div><!-- #aside close -->
